...
X_train,X_valid,y_train,y_valid = train_test_split(X_train,y_train,test_size=0.25,random_state=200)
...
# Validation Set
plot_roc(y_valid, y_hat1,'D2','valid data')

# Testing Set
plot_roc(y_test, y_hat2,'D2','test data')